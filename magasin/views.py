...
from .forms import ProduitForm, FournisseurForm, UserRegistrationForm, UserCreationForm, CommandeForm, CategorieForm,ProductForm
...
class ProduitListAPIView(APIView):
    def get(self, request):
        produits = Produit.objects.filter(id__in=[1, 2, 3])
